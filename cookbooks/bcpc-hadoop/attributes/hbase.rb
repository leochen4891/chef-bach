...
default['bcpc']['hadoop']['hbase']['client']['primarycalltimeout']['scan'] = 1_000_000
default['bcpc']['hadoop']['hbase']['client']['pause'] = 100
default['bcpc']['hadoop']['hbase']['client']['retries']['number'] = 35
default['bcpc']['hadoop']['hbase']['meta']['replica']['count'] = 3
default['bcpc']['hadoop']['hbase']['meta']['replicas']['use'] = true
...
default['bcpc']['hadoop']['hbase_master']['loadbalancer']['class'] = 'org.apache.hadoop.hbase.master.balancer.StochasticLoadBalancer'
...
default['bcpc']['hadoop']['hbase_rs']['meta']['storefile']['refresh']['period'] = 30_000
