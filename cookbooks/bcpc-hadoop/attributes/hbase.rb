...
default[:bcpc][:hadoop][:hbase][:site_xml].tap do |site_xml|
  ...
  site_xml['hbase.master.balancer.stochastic.localityCost']              = 1_000
  site_xml['hbase.master.balancer.stochastic.tableSkewCost']             = 3_000
  ...
  # region replication server side
  site_xml['hbase.hregion.memstore.block.multiplier']                    = 8
  site_xml['hbase.master.hfilecleaner.ttl']                              = 3_600_000
  ...
  site_xml['hbase.regionserver.meta.storefile.refresh.period']           = 30_000
  site_xml['hbase.regionserver.storefile.refresh.all']                   = false
  site_xml['hbase.regionserver.storefile.refresh.period']                = 30_000
  # region replication client side
  site_xml['hbase.client.pause']                                         = 100
  site_xml['hbase.client.primaryCallTimeout.get']                        = 100_000
  site_xml['hbase.client.primaryCallTimeout.multiget']                   = 100_000
  site_xml['hbase.client.primaryCallTimeout.scan']                       = 1_000_000
  site_xml['hbase.client.retries.number']                                = 35
  site_xml['hbase.ipc.client.specificThreadForWriting']                  = true
  site_xml['hbase.meta.replicas.use']                                    = true
end
